import { changeUserOrganizationSchema, startUserTrialSchema, updateDevSubscriptionSchema } from '@spinner/shared-types';
...
export class StartUserTrialDto extends createZodDto(startUserTrialSchema) {}
