import { createDataFolderSchema, refreshConnectionSchemasSchema, updateDataFolderSchema } from '@spinner/shared-types';
...
export class RefreshConnectionSchemasDto extends createZodDto(refreshConnectionSchemasSchema) {}
