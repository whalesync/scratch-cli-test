...
- **Live spec:** none yet — 📄 ❌ (no `server/test/integration/wordpress-connector.spec.ts`).
- **Runs in CI pipeline:** ❌.
...
- **Notes:** No live integration spec yet. Fake available at `test-api-fakes/wordpress`.
