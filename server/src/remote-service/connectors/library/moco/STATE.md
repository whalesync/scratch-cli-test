...
- **Live spec:** none yet — 📄 ❌ (no `server/test/integration/moco-connector.spec.ts`).
- **Runs in CI pipeline:** ❌.
...
- **Notes:** No live integration spec yet. Fake available at `test-api-fakes/moco`.
