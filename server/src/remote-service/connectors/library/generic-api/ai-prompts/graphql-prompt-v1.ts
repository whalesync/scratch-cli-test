/**
 * Inlined prompt (built from graphql-prompt-v1.md). Edit the .md and re-run
...
export const GRAPHQL_PROMPT_V1 = `You are helping a user connect their data tool (Scratch) to an external GraphQL API.
