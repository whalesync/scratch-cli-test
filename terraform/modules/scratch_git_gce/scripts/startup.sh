...
# SCRATCH_GIT_AUTH_TOKEN (DEV-10600) — the shared bearer token the NestJS server presents.
# Tolerate a not-yet-created/empty secret so the boot can't hard-fail on rollout ordering;
