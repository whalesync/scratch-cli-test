...
const EXPECTED = ['@spinner/shared-types#dev', 'client#dev', 'scratch-git-2#dev', 'server#dev'];
...
if (JSON.stringify(actual) !== JSON.stringify(EXPECTED)) {
  ...
  console.log('If you added or removed a dev service, update EXPECTED in scripts/verify-turbo-dev.mjs.');
  process.exit(1);
}
