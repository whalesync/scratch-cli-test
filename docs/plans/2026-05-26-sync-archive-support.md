...
- **Lane D (client)** — T11 (sync-edit UI: stacked layout, accordion, policy pickers, ConfirmDialog), T12 (v1 JSON paste auto-upgrade flow). Unblocked now that the server persists v2. **Last remaining lane.**
...
- **Lane D** — unblocked; client editor remains. **The only lane still open.**
