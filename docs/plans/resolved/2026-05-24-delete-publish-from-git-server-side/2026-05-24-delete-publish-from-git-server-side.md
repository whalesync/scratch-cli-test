...
**Related**: [`resolved/2026-05-17-simplify-local-workspace-architecture.md`](../2026-05-17-simplify-local-workspace-architecture/2026-05-17-simplify-local-workspace-architecture.md) — Phase 7a (caller-side removal) shipped on `mr39` 2026-05-23; this plan is the server-side counterpart. Originally tracked inline as "Phase 7" in the main plan; extracted into its own doc 2026-05-24 to keep the parent plan compact now that everything else there has shipped or been cancelled.
