...
- **No canonicalization of user edits on accept/upload.** Editors still produce whatever JSON they produce; the detector absorbs harmless byte differences (unchanged from [2026-05-27-unreviewed-detection-semantic-compare](../2026-05-27-unreviewed-detection-semantic-compare/2026-05-27-unreviewed-detection-semantic-compare.md)).
