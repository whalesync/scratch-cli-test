...
> **Implementation status (2026-06-23):** Implemented and **merged to `master`** via [MR !2837](https://gitlab.com/whalesync/spinner/-/merge_requests/2837) (squash commit `e9d7b4441`).
>
