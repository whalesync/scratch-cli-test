...
**Related**: [`resolved/2026-05-17-simplify-local-workspace-architecture.md`](../resolved/2026-05-17-simplify-local-workspace-architecture/2026-05-17-simplify-local-workspace-architecture.md) slice H.4 deferred the Windows napi `.node`; this plan closes that gap.
...
| `docs/plans/resolved/2026-05-20-slice-h-spec/2026-05-20-slice-h-spec.md:463` (planning doc) | `scratchmd-native.win32-x64-msvc.node`                  |
