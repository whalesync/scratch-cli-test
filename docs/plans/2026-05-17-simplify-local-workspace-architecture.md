...
Second dogfood pass against `wkb_3qH9SlxsNq` (Monorepo, 5 connectors, 135k files) focused on the publishing workflow. Three findings — two bugs fixed in-MR (D7 perf, D9 UX-block), one design question open (D8 baseHead).
