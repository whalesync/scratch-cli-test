...
> | F     | Init rewrite: one non-sparse worktree per connection on `refs/heads/main`; drop sparse `dirty` and `master` worktrees. Migration of in-flight workspaces by refuse + re-init prompt (not auto-rebuild, see [slice F spec](2026-05-20-slice-f-spec.md#migration-of-in-flight-workspaces)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | **F.1 + F.2.a + F.2.b + F.3 shipped** (2026-05-20). F.4 (perf measurement) not started. ~500 LOC across the four sub-slices.                                                                                                                          |
