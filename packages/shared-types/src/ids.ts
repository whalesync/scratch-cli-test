...
// ------- WorkspaceInvite -------
export type WorkspaceInviteId = PrefixedId<IdPrefixes.WORKSPACE_INVITE>;

export function isWorkspaceInviteId(id: unknown): id is WorkspaceInviteId {
  return isId(id, IdPrefixes.WORKSPACE_INVITE);
}
