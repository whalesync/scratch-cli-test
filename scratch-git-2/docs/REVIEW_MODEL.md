...
- The architecture-change plan at [`docs/plans/2026-05-17-simplify-local-workspace-architecture.md`](../../docs/plans/2026-05-17-simplify-local-workspace-architecture.md) — context for *why* this model exists (history of the move from a three-worktree model; not a learning resource).
