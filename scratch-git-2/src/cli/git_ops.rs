...
pub(crate) use local::{
    ...
    materialize_treeish_to_directory, read_tree_files, rev_parse_optional_to_string,
    rev_parse_to_string, setup_sparse_worktree, update_ref, worktree_reset_hard,
    worktree_reset_mixed, worktree_status_entries,
};
