...
> **Purpose**: This document provides explicit guidance for AI agents (like Claude) on how to use the standard UI components in the Scratch Desktop app. Follow these rules strictly to maintain consistency.
...
var(--bg-selected)    /* Selected items, or something to contrast with panel */
```
...
1. Review existing pages for patterns
2. Check the base components in `@/components/base/`
3. When in doubt, ask before creating custom styles
